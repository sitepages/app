...
import { Settings, Plus, Pencil, Trash2, X, Check, Download, Tag, Hash } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-7 max-w-[900px] mx-auto">
      ...
      {/* Tabs */}
      <div className="flex gap-1 mb-6 animate-fade-up-1"
      ...
      {activeTab === 'rules' && (
        <div className="animate-fade-up-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => setShowRuleForm(true)} className="btn btn-primary">
            ...
            <div className="flex gap-2 flex-wrap">
              {PRESET_ICONS.map(icon => (
                <button key={icon} type="button"
                  ...
                  style={{ width: 36, height: 36, borderRadius: 8, fontSize: 18, cursor: 'pointer', border: 'none',
