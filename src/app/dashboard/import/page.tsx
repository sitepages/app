      ...
      <div className="mt-8">
            ...
            <div className="text-center">
              {undoSuccess ? (
                ...
                <ImportSummary
                  ...
                  duplicates={state.duplicatesIgnored}
        ...
        {state.step === 'preview' && (
          <div className="space-y-5">
            <div
              className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl px-5 py-4"
...
function ImportSummary({ saved, duplicates, errors }: { saved: number; duplicates: number; errors: number }) {
    ...
    return (
      <>
        ...
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
          {duplicates} já existiam no sistema
  ...
  if (saved > 0 && duplicates > 0) {
    return (
      <>
        <p className="font-semibold mb-1" style={{ color: 'var(--text)' }}>
          {saved} transações importadas
        </p>
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
          {duplicates} ignoradas (já existiam)
          {errors > 0 && ` • ${errors} com erro`}
        </p>
      </>
    )
